...
describe Scale do
  ...
  it 'Creates Major scales correctly' do
    ...
    expect(scale.notes[0].equal?(NOTE_C_FLAT)).to be true
    expect(scale.notes[1].equal?(NOTE_D_FLAT)).to be true
    expect(scale.notes[2].equal?(NOTE_E_FLAT)).to be true
    expect(scale.notes[3].equal?(NOTE_F_FLAT)).to be true
    expect(scale.notes[4].equal?(NOTE_G_FLAT)).to be true
    expect(scale.notes[5].equal?(NOTE_A_FLAT)).to be true
    expect(scale.notes[6].equal?(NOTE_B_FLAT)).to be true
    expect(scale.notes[7].equal?(NOTE_C_FLAT)).to be true

    scale = described_class.new(root: NOTE_C_NATURAL, name: 'Major')

    expect(scale.notes[0].equal?(NOTE_C_NATURAL)).to be true
    expect(scale.notes[1].equal?(NOTE_D_NATURAL)).to be true
    expect(scale.notes[2].equal?(NOTE_E_NATURAL)).to be true
    expect(scale.notes[3].equal?(NOTE_F_NATURAL)).to be true
    expect(scale.notes[4].equal?(NOTE_G_NATURAL)).to be true
    expect(scale.notes[5].equal?(NOTE_A_NATURAL)).to be true
    expect(scale.notes[6].equal?(NOTE_B_NATURAL)).to be true
    expect(scale.notes[7].equal?(NOTE_C_NATURAL)).to be true

    scale = described_class.new(root: NOTE_C_SHARP, name: 'Major')

    expect(scale.notes[0].equal?(NOTE_C_SHARP)).to be true
    expect(scale.notes[1].equal?(NOTE_D_SHARP)).to be true
    expect(scale.notes[2].equal?(NOTE_E_SHARP)).to be true
    expect(scale.notes[3].equal?(NOTE_F_SHARP)).to be true
    expect(scale.notes[4].equal?(NOTE_G_SHARP)).to be true
    expect(scale.notes[5].equal?(NOTE_A_SHARP)).to be true
    expect(scale.notes[6].equal?(NOTE_B_SHARP)).to be true
    expect(scale.notes[7].equal?(NOTE_C_SHARP)).to be true
  end
  ...
  it 'Creates Dorian scales correctly' do
    ...
    expect(scale.notes[0].equal?(NOTE_C_FLAT)).to be true
    expect(scale.notes[1].equal?(NOTE_D_FLAT)).to be true
    expect(scale.notes[2].equal?(NOTE_E_D_FLAT)).to be true
    expect(scale.notes[3].equal?(NOTE_F_FLAT)).to be true
    expect(scale.notes[4].equal?(NOTE_G_FLAT)).to be true
    expect(scale.notes[5].equal?(NOTE_A_FLAT)).to be true
    expect(scale.notes[6].equal?(NOTE_B_D_FLAT)).to be true
    expect(scale.notes[7].equal?(NOTE_C_FLAT)).to be true
  ...
  it 'Creates Phrygian scales correctly' do
    ...
    expect(scale.notes[0].equal?(NOTE_C_FLAT)).to be true
    expect(scale.notes[1].equal?(NOTE_D_D_FLAT)).to be true
    expect(scale.notes[2].equal?(NOTE_E_D_FLAT)).to be true
    expect(scale.notes[3].equal?(NOTE_F_FLAT)).to be true
    expect(scale.notes[4].equal?(NOTE_G_FLAT)).to be true
    expect(scale.notes[5].equal?(NOTE_A_D_FLAT)).to be true
    expect(scale.notes[6].equal?(NOTE_B_D_FLAT)).to be true
    expect(scale.notes[7].equal?(NOTE_C_FLAT)).to be true
  ...
  it 'Creates Lydian scales correctly' do
    ...
    expect(scale.notes[1].equal?(NOTE_D_SHARP)).to be true
    expect(scale.notes[2].equal?(NOTE_E_SHARP)).to be true
    expect(scale.notes[3].equal?(NOTE_F_D_SHARP)).to be true
    expect(scale.notes[4].equal?(NOTE_G_SHARP)).to be true
    expect(scale.notes[5].equal?(NOTE_A_SHARP)).to be true
    expect(scale.notes[6].equal?(NOTE_B_SHARP)).to be true
    expect(scale.notes[7].equal?(NOTE_C_SHARP)).to be true
  ...
  it 'Creates Locrian scales correctly' do
    ...
    expect(scale.notes[2].equal?(NOTE_E_D_FLAT)).to be true
    expect(scale.notes[3].equal?(NOTE_F_FLAT)).to be true
    expect(scale.notes[4].equal?(NOTE_G_D_FLAT)).to be true
    expect(scale.notes[5].equal?(NOTE_A_D_FLAT)).to be true
    expect(scale.notes[6].equal?(NOTE_B_D_FLAT)).to be true
    expect(scale.notes[7].equal?(NOTE_C_FLAT)).to be true
  ...
  it 'Creates Ionian #5 scales correctly' do
    ...
    expect(scale.notes[2].equal?(NOTE_E_SHARP)).to be true
    expect(scale.notes[3].equal?(NOTE_F_SHARP)).to be true
    expect(scale.notes[4].equal?(NOTE_G_D_SHARP)).to be true
    expect(scale.notes[5].equal?(NOTE_A_SHARP)).to be true
    expect(scale.notes[6].equal?(NOTE_B_SHARP)).to be true
    expect(scale.notes[7].equal?(NOTE_C_SHARP)).to be true
  end
  ...
  it 'Creates Lydian #2 scales correctly' do
    ...
    expect(scale.notes[0].equal?(NOTE_C_SHARP)).to be true
    expect(scale.notes[1].equal?(NOTE_D_D_SHARP)).to be true
    expect(scale.notes[2].equal?(NOTE_E_SHARP)).to be true
    expect(scale.notes[3].equal?(NOTE_F_D_SHARP)).to be true
    expect(scale.notes[4].equal?(NOTE_G_SHARP)).to be true
    expect(scale.notes[5].equal?(NOTE_A_SHARP)).to be true
  ...
  it 'Creates Super Locrian scales correctly' do
    ...
    expect(scale.notes[1].equal?(NOTE_D_D_FLAT)).to be true
    expect(scale.notes[2].equal?(NOTE_E_D_FLAT)).to be true
    expect(scale.notes[3].equal?(NOTE_F_D_FLAT)).to be true
    expect(scale.notes[4].equal?(NOTE_G_D_FLAT)).to be true
    expect(scale.notes[5].equal?(NOTE_A_D_FLAT)).to be true
    expect(scale.notes[6].equal?(NOTE_B_D_FLAT)).to be true
    expect(scale.notes[7].equal?(NOTE_C_FLAT)).to be true
