...
describe Interval do
  it 'Calculates a diminished second (d2) up correctly' do
    note2 = [NOTE_D_D_FLAT.dup, NOTE_E_D_FLAT.dup, NOTE_F_FLAT.dup, \
             NOTE_G_D_FLAT.dup, NOTE_A_D_FLAT.dup, NOTE_B_D_FLAT.dup, \
             NOTE_C_FLAT.dup]
  ...
  it 'Calculates a diminished Second (d2) down correctly' do
    note2 = [NOTE_B_SHARP.dup, NOTE_C_D_SHARP.dup, NOTE_D_D_SHARP.dup, \
             NOTE_E_SHARP.dup, NOTE_F_D_SHARP.dup, NOTE_G_D_SHARP.dup, \
             NOTE_A_D_SHARP.dup]
